...
public class Heart extends AppCompatActivity {
    private String TAG = Heart.class.getName();
    ...
    Button btnStart, feedbackResult;
    ProgressBar spinner;
...
/*
        Integer IntHeartBeat;
        heartBeat = (int) hb.getHeartBeat();
*/
        ...
        feedbackResult.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                //finish();

                Intent intent = new Intent(Heart.this, SubActivity.class);
                intent.putExtra("heartBeat", intheartBeat);
                startActivity(intent);

                //Intent intent = new Intent(getApplicationContext(), SubActivity.class);
                //intent.putExtra("lastHeartBeat", )
        ...
        onDataPointListener = new OnDataPointListener() {
            ...
            public void onDataPoint(DataPoint dataPoint) {
                for (Field field : dataPoint.getDataType().getFields()) {
                    final Value aValue = dataPoint.getValue(field);
    ...
    private synchronized void addContentToView(final float value) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(TAG,"현재의 심박수는 : " + value + " 입니다.");
                textMon.setText("현재의 심박수는 : " + value + " 입니다.");
/*
//                if (value >= 80) {
...
//                */
                ...
                hb.setHeartBeat(value);
                intheartBeat = (int) hb.getHeartBeat();
            }
        });
 ...
 class HeartBeat {
    ...
    public void setHeartBeat(Float a) { this.heartBeat = a;}
